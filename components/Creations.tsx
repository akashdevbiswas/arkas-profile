...
const Creations = () => {
  return (
    <div id="creations" className="my-[20px] md:my-[100px]">
      <Heading heading="Creations of the Author"/>
      <div className="mt-[40px] md:mt-[60px] lg:mt-[120px] gradient_bg2 relative py-[80px] flex lg:block flex-col items-center gap-5">
        ...
        <div className="main__container w-fit mx-auto flex flex-col gap-5 my-auto text-center md:text-left px-[10px] md:px-0 ">
          ...
          <h4 className="text-3xl md:text-4xl lg:text-[40px] italiana-regular">
            The season of Crimson Red
          </h4>
          ...
          <Button btnType="primary" buttonName={"Purchase"} className="w-full md:w-[181px]" url="/purchase" />
        </div>
      </div>
    </div>
  );
