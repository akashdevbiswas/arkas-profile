...
import { Book, BuyOption } from "@/constants";
...
const PurchasePage = () => {
  ...
  return (
    <div className="p-[1px]">
      <div className="main__container h-fit top-1/2 left-1/2 flex flex-col md:flex-row justify-between mt-[50px] md:mt-[100px] mx-auto">
